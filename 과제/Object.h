...
public:
	...
	int LoadTextureFromDDSFile(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, CGameObject* pParent, FILE* pInFile, CShader* pShader, UINT nIndex);
...
protected:
	...
	XMFLOAT3						m_xmf3AABBExtents = XMFLOAT3(2.0f, 2.0f, 15.0f);
...
{
	bool m_renderState = false;
public:
	bool GetState() { return m_renderState; }
	void SetState(bool in) { m_renderState = in; }
